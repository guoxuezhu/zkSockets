...
public class EventActivity extends BaseActivity {
    ...
    public void evbtn_ok() {
        ...
        mLsListsDao.update(new MLsLists((long) 64, "一体机开", event_et_64.getText().toString(), event_tv_time_64.getText().toString()));
        mLsListsDao.update(new MLsLists((long) 65, "一体机关", event_et_65.getText().toString(), event_tv_time_65.getText().toString()));
