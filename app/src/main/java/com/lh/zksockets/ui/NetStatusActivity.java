...
public class NetStatusActivity extends BaseActivity {
    ...
    private void setData() {
        ...
        if (serialPortDataDao.loadAll().size() < 4) {
            serialPortDataDao.insert(new SerialPortData((long) 1, "串口1", "投影机", 3, "9600", 0, "NONE", 0, "8", 0, "1", 16));
            serialPortDataDao.insert(new SerialPortData((long) 2, "串口2", "外部继电器", 3, "9600", 0, "NONE", 0, "8", 0, "1", 16));
            serialPortDataDao.insert(new SerialPortData((long) 3, "串口3", "电源时序器", 6, "57600", 0, "NONE", 0, "8", 0, "1", 16));
            serialPortDataDao.insert(new SerialPortData((long) 4, "串口4", "", 3, "9600", 0, "NONE", 0, "8", 0, "1", 16));
            serialPortDataDao.insert(new SerialPortData((long) 5, "串口5", "红外", 3, "9600", 0, "NONE", 0, "8", 0, "1", 16));
            serialPortDataDao.insert(new SerialPortData((long) 6, "串口6", "一体机", 7, "115200", 0, "NONE", 0, "8", 0, "1", 16));
            serialPortDataDao.insert(new SerialPortData((long) 7, "串口7", "音量", 7, "115200", 0, "NONE", 0, "8", 0, "1", 10));
            serialPortDataDao.insert(new SerialPortData((long) 8, "串口8", "温湿度", 3, "9600", 0, "NONE", 0, "8", 0, "1", 16));
        ...
        if (mLsListsDao.loadAll().size() == 0) {
            ...
            mLsListsDao.insert(new MLsLists((long) 3, "窗帘开", "2-2-1", ""));
            mLsListsDao.insert(new MLsLists((long) 4, "窗帘关", "2-1-1", ""));
            ...
            mLsListsDao.insert(new MLsLists((long) 13, "灯光开", "1-205", ""));
            mLsListsDao.insert(new MLsLists((long) 14, "灯光关", "1-206", ""));
            mLsListsDao.insert(new MLsLists((long) 15, "灯光1开(关)", "", ""));
            mLsListsDao.insert(new MLsLists((long) 16, "灯光1关", "", ""));
            mLsListsDao.insert(new MLsLists((long) 17, "灯光2开(关)", "3-1-1", ""));
            mLsListsDao.insert(new MLsLists((long) 18, "灯光2关", "3-2-1", ""));
            mLsListsDao.insert(new MLsLists((long) 19, "灯光3开(关)", "3-3-1", ""));
            mLsListsDao.insert(new MLsLists((long) 20, "灯光3关", "3-4-1", ""));
            ...
            mLsListsDao.insert(new MLsLists((long) 42, "空调-制冷", "4-2-0", ""));
            mLsListsDao.insert(new MLsLists((long) 43, "空调-制热", "4-3-0", ""));
            mLsListsDao.insert(new MLsLists((long) 44, "空调-风速", "4-4-0", ""));
            ...
            mLsListsDao.insert(new MLsLists((long) 55, "电视机4", "2-4-1", ""));
            mLsListsDao.insert(new MLsLists((long) 56, "电视机5", "2-5-1", ""));
        ...
        if (ioYuanDao.loadAll().size() == 0) {
            ioYuanDao.insert(new IOYuan((long) 1, "报警1", "", 0, "3-1-1", "3-1-0"));
            ioYuanDao.insert(new IOYuan((long) 2, "报警2", "", 0, "3-2-1", "3-2-0"));
            ioYuanDao.insert(new IOYuan((long) 3, "报警3", "人体感应", 1, "3-3-1", "3-3-0"));
            ioYuanDao.insert(new IOYuan((long) 4, "报警4", "", 0, "3-4-1", "3-4-0"));
        }
        ...
        if (jdqStatusDao.loadAll().size() == 0) {
            ...
            jdqStatusDao.insert(new JDQstatus((long) 5, "继电器5", "", 1, 10));
            jdqStatusDao.insert(new JDQstatus((long) 6, "继电器6", "", 1, 10));
