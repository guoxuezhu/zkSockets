        ...
        try {
            ...
            if (msgdata.indexOf("]") != -1) {
                ...
                if (msgdata.substring(0, msgdata.indexOf("]") + 1).equals("[OK]")) {
                    ...
                    ELog.i("===========COM3=====test======111111=======" + msgdata.indexOf(">"));
                    if (msgdata.indexOf(">") != -1) {
                        if (msgdata.indexOf(">") == 16) {
                            ...
                            ELog.i("===========COM3=====00000000=============" + new String(buffer2, 0, bslength));
                            buffer1 = new byte[1024];
                            System.arraycopy(buffer2, 0, buffer1, 0, bslength);
                            buffer2 = new byte[1024];
                            makeData(new String(buffer1, 0, bslength));
                            ...
                            if (msgdata.indexOf("]", 6) != -1) {
                                ELog.i("===========COM3=====1111111=============" + msgdata.substring(msgdata.indexOf(">") + 1, msgdata.indexOf("]", 6) + 1));
                                if (msgdata.substring(msgdata.indexOf(">") + 1, msgdata.indexOf("]", 6) + 1).equals("[COM3]")) {
                                    ...
                                    if (bslength - 16 == 9) {
                                        ...
                                        ELog.i("==========COM3======2222222222222222222222=============" + new String(buffer2, 0, bslength));
                                        buffer1 = new byte[1024];
                                        System.arraycopy(buffer2, 0, buffer1, 0, bslength);
                                        buffer2 = new byte[1024];
                                        makeData(new String(buffer1, 0, bslength));
                                        ...
                                        ELog.i("===========COM3======333333333333333333======" + new String(buffer2, 0, bslength));
                                        buffer1 = new byte[1024];
                                        System.arraycopy(buffer2, 0, buffer1, 0, bslength);
                                        buffer2 = new byte[1024];
                                        makeData(new String(buffer1, 0, bslength));
                                    ...
                                    bslength = bslength - msgdata.indexOf(">") - 1;
                                    System.arraycopy(buffer1, msgdata.indexOf(">") + 1, buffer2, 0, bslength);
                                    ELog.i("===========COM3======444444444444======" + new String(buffer2, 0, bslength));
                                    buffer1 = new byte[1024];
                                    System.arraycopy(buffer2, 0, buffer1, 0, bslength);
                                    buffer2 = new byte[1024];
                                    makeData(new String(buffer1, 0, bslength));
