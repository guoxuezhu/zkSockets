...
/** 
 * DAO for table "EVENT_KEJIAN_REST".
*/
public class EventKejianRestDao extends AbstractDao<EventKejianRest, Void> {

    public static final String TABLENAME = "EVENT_KEJIAN_REST";

    /**
     * Properties of entity EventKejianRest.<br/>
    ...
    public EventKejianRestDao(DaoConfig config) {
        super(config);
    }
    
    public EventKejianRestDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"EVENT_KEJIAN_REST\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"EVENT_KEJIAN_REST\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, EventKejianRest entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, EventKejianRest entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getEventType());
    ...
    @Override
    public EventKejianRest readEntity(Cursor cursor, int offset) {
        EventKejianRest entity = new EventKejianRest( //
    ...
    @Override
    public void readEntity(Cursor cursor, EventKejianRest entity, int offset) {
    ...
    @Override
    protected final Void updateKeyAfterInsert(EventKejianRest entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(EventKejianRest entity) {
        return null;
    }

    @Override
    public boolean hasKey(EventKejianRest entity) {
        // TODO
        return false;
    }
